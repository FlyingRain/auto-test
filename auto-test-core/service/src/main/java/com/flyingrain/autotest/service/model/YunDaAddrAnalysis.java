...
public class YunDaAddrAnalysis {
    ...
    public String getSend_Province_Name() {
        return Send_Province_Name;
    }

    public void setSend_Province_Name(String send_Province_Name) {
    ...
    public String getSend_Area_Name() {
        return Send_Area_Name;
    }

    public void setSend_Area_Name(String send_Area_Name) {
        Send_Area_Name = send_Area_Name;
    }
